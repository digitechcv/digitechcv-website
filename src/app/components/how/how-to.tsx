      ...
      <Container className='how-to-container'>
        ...
        <Row xs={1} md={2} lg={3} className="justify-content-center container-how-to">
          <Col className="d-flex justify-content-center">
            <Card style={{ backgroundColor: '#102a54' }} className='text-white p-5 card-how-to my-5'>
          ...
          <Col className="d-flex justify-content-center">
            <Card style={{ backgroundColor: '#104cba' }} className='text-white p-5 my-5 card-how-to'>
              <Image src={'/images/how2.png'} alt='' width={100} height={100} className='img-fluid mx-auto d-block img-how-to' />
              <Card.Body>
                <Card.Title className='text-center'>Planejamento</Card.Title>
                <Card.Text>
          ...
          <Col className="d-flex justify-content-center">
            <Card style={{ backgroundColor: '#102a54' }} className='text-white p-5 my-5 card-how-to'>
              <Image src={'/images/how3.png'} alt='' width={100} height={100} className='img-fluid mx-auto d-block img-how-to3' />
              <Card.Body>
